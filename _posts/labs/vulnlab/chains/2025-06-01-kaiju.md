...
We see that Keepass is running. We can try using [KeeFarceReborn](https://github.com/x746b/KeeFarceReborn). First we need to enable plugins for KeePass. So change the `KeePass.config.xml` file in `E:\public\software\keepass2\`
```
